# Generated by Django 3.0.8 on 2021-05-19 16:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_name', models.CharField(blank=True, max_length=200, null=True, unique=True, verbose_name='Görünüm Adı')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_list', ckeditor.fields.RichTextField(null=True, verbose_name='Telefonlar')),
                ('footer_address', models.TextField(null=True, verbose_name='Footer Adres')),
                ...
                ('bip', models.URLField(blank=True, null=True, verbose_name='Bip')),
                ...
                ('hours_of_service', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Hizmet Saati')),
                ('user_agreement', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Kullanıcı Sözleşmesi')),
                ('privacy_policy', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Gizlilik Politikası')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.CharField(blank=True, editable=False, max_length=255, null=True)),
                ('text', models.CharField(max_length=200, null=True, verbose_name='Başlık')),
                ('view_name', models.CharField(blank=True, max_length=200, null=True, verbose_name='Görünüm Adı')),
